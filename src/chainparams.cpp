...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex(MAIN_PUBKEY) << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        // TODO: From https://stackoverflow.com/questions/47828172/encountering-readblockfromdisk-errors-in-block-header-at-cblockdiskposnfile-0/48606397
        ...
        genesis = CreateGenesisBlock(MAIN_TIME, MAIN_NONCE, MAIN_BITS, 1, 50 * COIN);
        ...
        // TODO: I'm not touching that since for just mining/transaction it should not be necessary
        // some info about how to generate this if necessary https://github.com/dashpay/dash/issues/2284
        ...
        chainTxData = ChainTxData{
            MAIN_TIME, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // TODO: I don't care about other networks than main for test purposes
